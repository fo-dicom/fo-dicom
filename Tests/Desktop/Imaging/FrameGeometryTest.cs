...
namespace Dicom.Imaging
{
    ...
    public class FrameGeometryTest
    {
        ...
        [Theory]
        [InlineData(@"Test Data\CR-ModalitySequenceLUT.dcm", FrameGeometryType.Plane, 7.5)]
        [InlineData(@"Test Data\CT1_J2KI", FrameGeometryType.Volume, 33.0734)]
        [InlineData(@"Test Data\GH645.dcm", FrameGeometryType.None, 0.0)]
        ...
        public void ThrowWhenTransformingWithoutGeometryData()
        {
            ...
            var image = new DicomImage(@"Test Data\CR-MONO1-10-chest");
            var geometry = new FrameGeometry(image.Dataset);
