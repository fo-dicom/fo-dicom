...
namespace FellowOakDicom.Tests
{
    ...
    public class DicomDatasetTest
    {
        ...
        [Fact]
        public void EqualityOperator_DifferentEmptyDatasets_ShouldReturnTrue()
        {
            var dataset1 = new DicomDataset();
            var dataset2 = new DicomDataset();
            Assert.True(dataset1.Equals(dataset2));
        ...
        [Fact]
        public void EqualityOperator_SameDataDatasets_ShouldReturnTrue()
        {
            var dataset1 = new DicomDataset();
            var dataset2 = new DicomDataset();
            var tag = DicomTag.URNCodeValue;
        ...
        [Fact]
        public void EqualityOperator_DifferentDataDatasets_ShouldReturnFalse()
        {
            var dataset1 = new DicomDataset();
            var dataset2 = new DicomDataset();
            var tag1 = DicomTag.URNCodeValue;
