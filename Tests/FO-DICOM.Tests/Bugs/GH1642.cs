...
namespace FellowOakDicom.Tests.Bugs
{
    ...
    public class GH1642
    {
        ...
        public async Task DicomClientFallbackEncoding()
        {
            ...
            using var server = DicomServerFactory.Create<CFindProvider>("127.0.0.1", 0, logger: serverLogger, fallbackEncoding: DicomEncoding.GetEncoding("ISO_IR 100"));

            var client = DicomClientFactory.Create("127.0.0.1", server.Port, false, "CLIENT", "SERVER");
