...
namespace Dicom {
	public static class DicomEncoding {
		...
		public static Encoding GetEncoding(string charset) {
			...
			switch (charset.Trim()) {
			case "ISO IR 13":  case "ISO_IR 13":  return Encoding.GetEncoding(932);   // JIS X 0201 (Shift JIS) Unextended
			case "ISO IR 100": case "ISO_IR 100": return Encoding.GetEncoding(28591); // Latin Alphabet No. 1 Unextended
			case "ISO IR 101": case "ISO_IR 101": return Encoding.GetEncoding(28592); // Latin Alphabet No. 2 Unextended
			case "ISO IR 109": case "ISO_IR 109": return Encoding.GetEncoding(28593); // Latin Alphabet No. 3 Unextended
			case "ISO IR 110": case "ISO_IR 110": return Encoding.GetEncoding(28594); // Latin Alphabet No. 4 Unextended
			case "ISO IR 126": case "ISO_IR 126": return Encoding.GetEncoding(28597); // Greek Unextended
			case "ISO IR 127": case "ISO_IR 127": return Encoding.GetEncoding(28596); // Arabic Unextended
			case "ISO IR 138": case "ISO_IR 138": return Encoding.GetEncoding(28598); // Hebrew Unextended
			case "ISO IR 144": case "ISO_IR 144": return Encoding.GetEncoding(28595); // Cyrillic Unextended
			case "ISO IR 148": case "ISO_IR 148": return Encoding.GetEncoding(28599); // Latin Alphabet No. 5 (Turkish) Unextended
			case "ISO IR 166": case "ISO_IR 166": return Encoding.GetEncoding(874);   // TIS 620-2533 (Thai) Unextended
			case "ISO IR 192": case "ISO_IR 192": return Encoding.GetEncoding(65001); // Unicode in UTF-8
