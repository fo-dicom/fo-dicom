...
namespace Dicom.Network {
	public class DicomCFindRequest : DicomRequest {
		...
		public DicomCFindRequest(DicomQueryRetrieveLevel level, DicomPriority priority = DicomPriority.Medium) : base(DicomCommandField.CFindRequest, DicomUID.VerificationSOPClass, priority) {
