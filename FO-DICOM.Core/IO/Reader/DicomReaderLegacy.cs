...
namespace FellowOakDicom.IO.Reader
{
    ...
    /// </summary>
    internal class DicomReaderLegacy : IDicomReader
    {
        ...
        /// <summary>
        /// Initializes an instance of <see cref="DicomReaderLegacy"/>.
        /// </summary>
        public DicomReaderLegacy(IMemoryProvider memoryProvider)
        {
